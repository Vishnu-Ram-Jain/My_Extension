...
const listed=(ele)=>{
    listedHTML=`<div style="display: flex;align-items: center;"> <span style="width: auto;"><i class="fa fa-trash-o de" data-index="0" id="${ind}" onclick="deleted(id)" style="font-size:24px ;width: auto;"></i></span><li  class="design">${ele}</li><br></div>`;
    mHTML+=listedHTML;
    ind++;
}
